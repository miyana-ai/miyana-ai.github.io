        ...
        class BaseFilterFrontendModule extends elementorModules.Module {
            ...
            consolidateFiltersForLoopWidget(e) {
                ...
                for (const e in t) {
                    ...
                    n[o][r.selectedTaxonomy].includes(r.term) || n[o][r.selectedTaxonomy].push(r.term)
                }
            ...
            updateURLQueryString(e) {
                ...
                for (const e in n)
                    s.set(e, n[e]);
                let r = s.toString();
                r = o.pageNum > 1 ? r ? this.formatQueryString(o.baseUrl, r) : o.baseUrl : r ? `?${r}` : location.pathname,
